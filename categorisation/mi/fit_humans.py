...
def optimize(args):
    ...
    model_path = f"{SYS_PATH}/categorisation/trained_models/{args.model_name}.pt"
    if args.task_name == 'badham2017':
        env = Badham2017()
        task_features = {}
    elif args.task_name == 'devraj2022':
...
if __name__ == '__main__':
    ...
    save_path = f"{SYS_PATH}/categorisation/data/model_comparison/{args.task_name}_{args.model_name}_{args.method}_{optimizer}.npz"
