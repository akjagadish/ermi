...
#prior stds
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std1.0_run=0

# cosine scheduler
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0_cosineschedular

# annealing lambdas
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess10000_std0.1_run=0_annealed
...
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess60000_std0.1_run=0_regall
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess70000_std0.1_run=0_regall
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess80000_std0.1_run=0_regall
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --use-filename --model-name env=claude_dim2_model=transformer_num_episodes100000_num_hidden=32_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess90000_std0.1_run=0_regall
