...
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=32_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=64_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=128_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=4_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=2_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000000_std0.1_run=0
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess10000_std0.1_run=0_annealed
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess1000_std0.1_run=0_annealed
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess30000_std0.1_run=0_annealed
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess60000_std0.1_run=0_annealed
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess50000_std0.1_run=0_annealed
