...
# hidden units
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --ess 1000000 --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=32_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_essNone_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --ess 1000000 --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=64_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_essNone_std0.1_run=0
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --ess 1000000 --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=128_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_essNone_std0.1_run=0
...
# python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy bernoulli --paired --ess 1000 --model-name env=claude_dim2_model=transformer_num_episodes300000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_essNone_std0.1_run=0_annealed 
...
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --model-name env=claude_dim2_model=transformer_num_episodes10000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess50000_std0.1_run=0_regattn_only
python mi/simulate_model.py --paradigm decisionmaking --task-name binz2022 --exp-id 3 --policy greedy --paired --model-name env=claude_dim2_model=transformer_num_episodes10000_num_hidden=256_lr0.1_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossvariational_ess100000_std0.1_run=0_regattn_only
