...
# python synthesize_problems.py --model NA --task functionlearning --proc-id 0 --num-runs 100 --num-tasks 100 --num-dim 1 --max-length 10000 --run-gpt claude --prompt-version 0 

# python synthesize_problems.py --model NA --task functionlearning --proc-id 0 --num-runs 1 --num-tasks 100 -- num-dim 1 --max-length 10000 --run-gpt claude --prompt-version 0 
# python synthesize_problems.py --model NA --task functionlearning --proc-id 0 --num-runs 1 --num-tasks 10 --num-dim 1 --max-length 10000 --run-gpt claude --prompt-version 0 
