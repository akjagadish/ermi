...
#python mi/train_functionlearning.py --env-name claude_generated_functionlearningtasks_paramsNA_dim1_data20_tasks9991_run0_procid0_pversion2 --env-dir u/ajagadish/ermi/functionlearning/data --save-dir /ermi/functionlearning/trained_models/ --num-episodes 10 --save-every 100 --print-every 10 --max-steps 20 --num-dims 1 --first-run-id 0 --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
