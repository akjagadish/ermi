...
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --optimizer --num-iters 1 --model-name env=synthetic_model=transformer_num_episodes500000_num_hidden=256_lr0.0003_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_run=0_synthetic
...
# python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --optimizer --paired --num-iters 1 --model-name env=synthetic_model=transformer_num_episodes100000_num_hidden=256_lr0.0003_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedTrue_lossnll_run=2_synthetic
...
python mi/fit_humans.py --paradigm decisionmaking --task-name binz2022 --optimizer --num-iters 1 --model-name env=synthetic_model=transformer_num_episodes100000_num_hidden=256_lr0.0003_num_layers=6_d_model=64_num_head=8_noise0.0_shuffleTrue_pairedFalse_lossnll_run=test_synthetic
