...
python mi/train_decisionmaking.py --synthetic --env-name dim2synthetic --num-episodes 100000 --max-steps 10 --num-dims 2  --first-run-id 0 --loss bce --save-dir /u/ajagadish/ermi/decisionmaking/trained_models/ --save-every 100 --print-every 10  --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 