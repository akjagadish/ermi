...
python mi/train_decisionmaking.py  --paired --num-episodes 100000 --max-steps 20 --num-dims 2  --first-run-id 0 --loss bce --env-name claude_generated_functionlearningtasks_paramsNA_dim2_data20_tasks9254_run0_procid0_pversion2_unknown --env-dir /u/ajagadish/ermi/decisionmaking/data --save-dir /u/ajagadish/ermi/decisionmaking/trained_models/ --save-every 100 --print-every 10  --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 
...
python mi/train_decisionmaking.py --synthetic --paired --env-name synthetic --num-episodes 100000 --max-steps 10 --num-dims 2  --first-run-id 0 --loss bce --save-dir /u/ajagadish/ermi/decisionmaking/trained_models/ --save-every 100 --print-every 10  --noise 0.0 --model-name transformer --num_hidden 256 --num_layers 6 --d_model 64 --num_head 8 --batch_size 64 --shuffle 