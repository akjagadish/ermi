...
def simulate_synthetic_tasks(paradigm, num_tasks, nonlinear, num_dims, max_steps, noise, device, batch_size):
...
if __name__ == "__main__":
    ...
    simulate_synthetic_tasks(args.paradigm,args.num_tasks, args.nonlinear, args.num_dims,
