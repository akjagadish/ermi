...
def run(env_name, nonlinear, restart_training, restart_episode_id, num_episodes, synthetic, rmc, num_dims, max_steps, sample_to_match_max_steps, noise, shuffle, shuffle_features, print_every, save_every, num_hidden, num_layers, d_model, num_head, loss_fn, save_dir, device, lr, batch_size=64):
    ...
    for t in tqdm(range(start_id, int(num_episodes))):
        ...
        if (not t % save_every):
            ...
            acc = evaluate_classification(env_name=env_name, experiment=experiment, paired=False,
...
if __name__ == "__main__":
    ...
    for i in range(args.runs):
        ...
        run(env_name, args.nonlinear, args.restart_training, args.restart_episode_id, args.num_episodes, args.synthetic, args.rmc, args.num_dims, args.max_steps, args.sample_to_match_max_steps,
